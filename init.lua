...
-- Select all
vim.keymap.set("n", "<leader>v", "ggVG", { noremap = true, desc = "Select all" })
...
vim.keymap.set("n", "<leader>ln", ":Gitsigns next_hunk<CR>", { noremap = true, silent = true, desc = "Next hunk" })
vim.keymap.set("n", "<leader>lp", ":Gitsigns prev_hunk<CR>", { noremap = true, silent = true, desc = "Prev hunk" })
vim.keymap.set(
	"n",
	"<leader>li",
		...
		opts = {
			...
			format_on_save = function(bufnr)
				...
				local disable_filetypes =
					{ c = true, cpp = true, javascript = true, typescript = true, html = true, astro = true }
				return {
					timeout_ms = 500,
